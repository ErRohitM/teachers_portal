...
SECRET_KEY = 'django-insecure-w26*rj&ylj5b(lyf5alwjtax2hsat)bhf9ap#4i_q6ek0ed&js'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Use a different directory name, like 'staticfiles'
